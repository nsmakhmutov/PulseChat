...
ABR_POLL_INTERVAL   = 0.5

ABR_LOSS_HIGH       = 4.0
ABR_LOSS_LOW        = 0.5

ABR_JITTER_HIGH     = 40.0
ABR_JITTER_FACTOR   = 0.90

ABR_DECREASE_FACTOR = 0.82

ABR_INCREASE_FACTOR = 1.05

ABR_MIN_BITRATE     = 500_000
ABR_MAX_BITRATE     = 20_000_000

ABR_COOLDOWN_DECREASE = 1.0
ABR_COOLDOWN_INCREASE = 4.0
ABR_CLEAN_POLLS_FOR_INCREASE = 10
